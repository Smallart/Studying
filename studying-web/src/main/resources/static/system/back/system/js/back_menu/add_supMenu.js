layui.config({
...
}).use(['jquery','JqueryZtree','form'],function () {
    let $ = layui.jquery,
        ...
        async:{
            enable: true,
            type: 'get',
            url:'/system/menu/selectMenuZtree'
        },
        data:{
            simpleData: {
                enable: true,
    ...
    },searchToggle = $('#searchToggle'),events={
            fold:function () {
    ...
    function fuzzySearch(zTreeId, isHighLight, isExpand){
        ...
        form.on('submit(*)',function (data){
            var _keywords = data.field.menuName;
